  ...
  resources: {
    "en-US": {
      translation: {
        ...
        choose_start_date: "Provide start date in the given format (dd.mm.yyyy):",
        reconciliation_act_dates: "Date",
        reconciliation_act: "Reconciliation Act",
        for_period: "For period:",
        init_balance: "InitBalance",
        reconciliation_addition: "Addition",
        reconciliation_removal: "Removal",
        reconciliation_result: "Result",
        total: "Total",
        choose_end_date: "Provide end date in the given format (dd.mm.yyyy):",
        ...
        admin_not_found:
          "Admin is not found. Ensure that correct phone number is provided and user is admin",
...
Thank you for choosing MANNOL!`,
    ...
    "ru-RU": {
      translation: {
        ...
        reconciliation_act_dates: "Дата",
        for_period: "За период:",
        init_balance: "нач.остаток",
        reconciliation_addition: "покупка товара/возвраты оплат",
        reconciliation_removal: "оплата/возраты товара",
        reconciliation_result: "кон.остаток",
        total: "Итог",
        btn_list_requests: "📭Список Заявок",
        btn_add_admin: "➕Добавить Админа",
        btn_get_reconciliation_act: "🧾Получить Акт-Сверки",
        ...
        money_balance_positive_update: "Из-за удаления транзакции ваш баланс был УВЕЛИЧЕН",
        money_balance_negative_update: "Из-за удаления транзакции ваш баланс был УМЕНЬШЕН",
...
Благодарим вас за выбор MANNOL!`,
    ...
    "uz-UZ": {
      translation: {
        ...
        yes_sure: "✅Ha, albatta",
        admin_not_found: "Admin Not Found. Ensure that phonenumber is correct and user is admin",
        btn_get_reconciliation_act: "🧾Kelishuv hisobotini olish",
        user_not_found:
          "Foydalanuvchi topilmadi. Iltimos, /start buyrug'i bilan botni qayta ishga tushiring",
        ...
        bonuses_rules:
          "Mannoluz Bot Bonuses Usage Rules:\n\n1. Eligibility: Bonuses are available to registered users aged 18 and older\n2.Accrual: Bonuses are earned through specific actions and promotional activities.\n3. Transferability: Bonuses are non-transferable and cannot be shared.\n4. Limitations: Bonuses cannot be exchanged for cash or combined with other offers.\n5. Account Status: Bonuses may be forfeited if the account is suspended or terminated ",
        choose_end_date: "Tugash sanasini (kun.oy.yil) formatida kiriting:",
